function  [dmodel, perf] = Fit_DACE(S, Y, regr, corr, theta0, lob, upb)
...
% Determine theta
if  nargin > 5
  % Bound constrained non-linear optimization: Do this for param.no_trials
  % Pick the solution with the minimum value of perf and proceed
