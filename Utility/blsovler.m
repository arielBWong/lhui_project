...
global xl_g   
if isempty(xl)
    [xl, n, flag] =  llmatch(xu, prob, num_pop, num_gen,'EIMnext_dace',...
                                inisize_l, numiter_l, 'EIM_evaldace', 1, 'normalization_z'); 
...
if isempty(xl)
    [xl, n, ~] =  llmatch(xu, prob, num_pop, num_gen,'EIMnext_dace',...
                            inisize_l, numiter_l, 'EIM_evaldace', 1, 'normalization_z');
